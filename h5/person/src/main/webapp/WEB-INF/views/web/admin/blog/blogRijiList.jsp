...
<body>
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:;" onclick="add('添加','${pageContext.request.contextPath}/admin/blogRiji/addPage','800','500')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加</a></span></div>
...
"sAjaxSource" : '${pageContext.request.contextPath}/admin/blogRiji/data',
"aoColumns" :[

	{"mData" : "userName",'sClass' : 'center'},				
	{"mData" : "rijiContent",'sClass' : 'center'},				
...
"fnRowCallback": function( nRow, aData, iDisplayIndex ) {
	...
	$('td:eq(2)',nRow).html('<div class="zoomerImg"><img style="width: 40px;height: 40px;" src="'+aData.image+'" alt="" /></div>');
	$('td:eq(3)',nRow).html(app.inputDate.myformatterTime(new Date(aData.createTime)));
	$('td:eq(4)',nRow).html(app.addButton.del('del',aData.id));
	return nRow;
},
...
function del(id){
	layer.confirm('确认要删除吗？',function(index){
		$.ajax({
			"type" : 'post',
			"url" : "${pageContext.request.contextPath}/admin/blogRiji/del",
			"dataType" : "json",
			"data" : {
					id : id
			},
