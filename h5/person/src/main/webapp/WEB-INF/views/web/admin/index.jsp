<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@ taglib prefix="wy" uri="http://www.wybegin.cn/jsp/core"%>
...
<body>
	<%@ include file="/WEB-INF/views/web/admin/common/header.jsp"%>
	<%@ include file="/WEB-INF/views/web/admin/common/aside.jsp"%>
