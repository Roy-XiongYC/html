...
<body>
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:;" onclick="add('添加','${webroot}/admin/blogShuo/addPage?id=','500','300')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加</a></span></div>
...
"sAjaxSource" : '${pageContext.request.contextPath}/admin/blogShuo/data',
"aoColumns" :[

	{"mData" : "userName",'sClass' : 'center'},				
	{"mData" : "shuoContent",'sClass' : 'center'},				
...
"fnRowCallback": function( nRow, aData, iDisplayIndex ) {
	...
	$('td:eq(3)',nRow).html(app.addButton.del('del',aData.id));
	return nRow;
},
...
function del(id){
	layer.confirm('确认要删除吗？',function(index){
		$.ajax({
			"type" : 'post',
			"url" : "${webroot}/admin/blogShuo/del",
			"dataType" : "json",
			"data" : {
					id : id
			},
