	...
	<table id="table1" class="table table-border table-bordered table-bg">
		<thead>
			...
			<tr class="text-c">
										...
										<th name="guestContent">留言内容</th>
										<th name="createTime">留言时间</th>
										<th name="id">操作</th>
								</tr>
		</thead>
		<tbody>
...
"sAjaxSource" : '${pageContext.request.contextPath}/admin/blogGuest/data',
"aoColumns" :[

	{"mData" : "userName",'sClass' : 'center'},				
	{"mData" : "guestContent",'sClass' : 'center'},				
...
function del(id){
	layer.confirm('确认要删除吗？',function(index){
		$.ajax({
			"type" : 'post',
			"url" : "${pageContext.request.contextPath}/admin/blogGuest/del",
			"dataType" : "json",
			"data" : {
					id : id
			},
