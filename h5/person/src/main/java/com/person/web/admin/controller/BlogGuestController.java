...
@Controller
@RequestMapping(value = "admin/blogGuest")
public class BlogGuestController extends AdminAppController<BlogGuest> {

	@Autowired
	private IBlogGuestService service;

	@RequestMapping(value = "/listPage", method = { RequestMethod.GET })
	public String showList() {
		return "web/admin/blog/blogGuestList";
	}
	...
	public PageResult queryPage(
		...
		Criteria<BlogGuest> param = new Criteria<BlogGuest>();
