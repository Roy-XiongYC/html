...
public class BlogShuoRepositoryImpl implements IBlogShuoRepository{
	...
	public Integer insert(BlogShuo record){
		return sqlSessionTemplate.insert(MAPPER_NAMESPACE + ".insert", record);
	}

	public Integer updateByCriteria(Criteria<BlogShuo> param){
	...
	public Integer deleteByCriteria(Criteria<BlogShuo> param){
